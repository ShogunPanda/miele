...
exports.loadRoutesPlugin = exports.loadRoutes = void 0;
...
async function loadRoutes(instance, { routesFolder }) {
    ...
    for (const file of glob_1.sync(`${routesFolder}/**/*(*.ts|*.js)`)) {
        ...
        for (const route of routes) {
            ...
            const models = (_b = (_a = route.config) === null || _a === void 0 ? void 0 : _a.models) !== null && _b !== void 0 ? _b : false;
            if (models) {
                ...
                if (route.schema && body) {
                    ...
                    */
                    ...
                    const existingModels = (_f = (_e = (_d = route.schema.body) === null || _d === void 0 ? void 0 : _d.components) === null || _e === void 0 ? void 0 : _e.schemas) !== null && _f !== void 0 ? _f : {};
            ...
            if (customFormats) {
                Object.assign(customFormats, (_h = (_g = route === null || route === void 0 ? void 0 : route.config) === null || _g === void 0 ? void 0 : _g.customFormats) !== null && _h !== void 0 ? _h : {});
            }
