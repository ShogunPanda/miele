...
async function validateResponse(_req, reply, payload) {
    ...
    if (responsesValidator && reply.res.statusCode !== http_status_codes_1.INTERNAL_SERVER_ERROR) {
...
function addResponsesValidation(route) {
    ...
    route.config.responsesValidator = Object.entries(responses).reduce((accu, [code, schema]) => {
...
exports.addResponsesValidation = addResponsesValidation;
