...
function printRoutes(routes) {
    ...
    const output = routes.map((route) => {
        ...
        return `﹒ \x1b[32m${method}\x1b[0m ${url} \x1b[37m${_c = (_b = (_a = route) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.description, (_c !== null && _c !== void 0 ? _c : '')}\x1b[0m`;
    });
